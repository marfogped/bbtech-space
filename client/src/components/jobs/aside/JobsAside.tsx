...
const JobsAside: React.FC<JobsAsideProps> = ({ jobs, inputSearch, handleUserSearch, selectedFilters, handleFilterChange }) => {
    ...
    <>
        <nav className='bg-bkgGray/70 h-max backdrop-blur flexCenter flex-col p-3'>
            <div className='flex items-center self-start gap-2'>
              <MoveLeft size={32} />
              <Link className='font-zenKaku' to={"/"}>Back Home</Link> 
            </div>
        ...
        <div className='flex-1 bg-bkgGray/70 backdrop-blur p-3'>
            ...
            <div className='pt-5'>
              <h3 className='flex items-center gap-3 text-xl font-medium'> <ListFilterIcon size={28} /> Filters</h3>
              <ul className='pt-2'>
                  {
                      filters && filters.length ? (
                          ...
                          transition={{ duration: 0.5, delay: filterIdx * 0.1, ease: [0.87, 0, 0.13, 1] }}
