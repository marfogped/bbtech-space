...
const ServiceCard: React.FC = () => {
  return (
    <article className="bg-bkgGray hover:shadow-xl shadow-purplePrimary grid grid-rows-3 p-4 h-max gap-4">
      ...
      <div>
        <p className="font-zenKaku text-lg">
          ...
          opportunity search service is tailored for IT professionals aiming to
          advance their careers. We connect you with leading companies in search
          of your unique talents, ensuring your next career move is a triumph.
        </p>
      </div>
